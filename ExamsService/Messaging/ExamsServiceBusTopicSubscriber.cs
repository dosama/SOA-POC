...
{
    internal class ExamsServiceBusTopicSubscriber : IServiceBusTopicSubscriber
    {
        ...
        public ExamsServiceBusTopicSubscriber(IProcessData processData,
            IConfiguration configuration,
            ILogger<ExamsServiceBusTopicSubscriber> logger)
        {
